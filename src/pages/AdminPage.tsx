...
const KURSE_FIELDS = [
  ...
  { key: 'karten10_preis', label: '10er-Karten-Preis (EUR)', type: 'number' },
  { key: 'monatsabo_preis', label: 'Monatsabo-Preis (EUR)', type: 'number' },
];
const BUCHUNGEN_FIELDS = [
  ...
  { key: 'buchungsart', label: 'Buchungsart', type: 'lookup/radio', options: [{ key: 'einzel', label: 'Einzelbuchung' }, { key: 'karte_10', label: '10er-Karte' }, { key: 'abo_monat', label: 'Monatsabo' }, { key: 'abo_jahr', label: 'Jahresabo' }] },
